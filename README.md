...
<img width="809" height="692" alt="image" src="https://github.com/user-attachments/assets/37822d0d-264e-43de-a8b1-e64b596e9dc4" />

### 2. **상품(식품) 정보 관리**
- 사용자가 직접 상품 정보를 등록하고, 이미지(원재료, 영양정보표)를 S3에 업로드할 수 있습니다.
- 상품명, 카테고리 등 다양한 조건으로 상품을 검색하고 필터링하는 기능을 제공합니다.
- 상품 상세 정보 조회, 좋아요 기능을 제공합니다.
<img width="809" height="692" alt="image" src="https://github.com/user-attachments/assets/84d55561-40c4-4c8f-9749-feddb53ece51" />
<img width="809" height="692" alt="image" src="https://github.com/user-attachments/assets/aef297ca-d1bf-45ba-9740-88c2949f6948" />
...
<img width="809" height="692" alt="image" src="https://github.com/user-attachments/assets/60d0c0a9-5440-4814-9e5e-86982c19b51a" />
